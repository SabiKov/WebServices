...
<!-- First Page -->
		<div id='firstPage' data-role='page' data-theme='a'>
			<div id='firstPageHeader' data-role='header'>
				<a href='#popupAdd' data-transition='slidedown' data-rel='popup' data-position-to='window' class='ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-plus myBtn'>Add</a>
				<h1 class='pageTitle'>Toy Story</h1>
				<a href='#' class='ui-btn ui-icon-refresh ui-shadow ui-corner-all ui-btn-icon-left myBtn' id='pageRefresh' >Refresh</a>
			...
			<div id='firstPageContent' data-role='content'>
				<div id='firstPageSearchOption'>
					<fieldset class='ui-grid-b'>
						<div class='ui-block-a'>
							<select class='myBtn' name='select-choice' id='searchOption' 
								data-corners='true'
								data-mini='true'								
				...
				<div class='pageTitle'><h1>Stock Information</h1></div>
				<div id='firstPageDisplayBox'>
				</div>
			</div>
			<div data-role='footer' data-position='fixed'>
				<h4 id='footerText'>Created by Szabolcs Kovacs <br> email: skovacs33@gmail.com</h4>
			</div><!-- /footer -->
		</div>	
